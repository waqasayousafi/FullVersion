...
export const UploadCover = () => {
  ...
  return (
    <div className="flex gap-3 mb-1">
      <div
        className={`relative w-[120px] h-[120px] rounded-lg overflow-hidden ${isWhiteTheme ? "bg-gray-50 border border-gray-200" : "bg-secondary"}`}
      >
        <input
          type="file"
          accept="image/*"
      ...
      <div
        className={`w-[120px] h-[120px] rounded-lg flex items-center justify-center ${isWhiteTheme ? "bg-gray-50 border border-gray-200" : "bg-secondary"}`}
      >
        <input
          type="file"
          accept="image/*"
