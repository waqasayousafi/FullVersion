  ...
  return (
    <div className="min-h-screen bg-background overflow-y-auto">
      ...
      <div className="fixed bottom-0 left-0 right-0 px-4 py-3 flex gap-3">
        <Button
          variant="secondary"
          className={`flex-1 h-12 text-sm font-bold flex items-center justify-center ${location.pathname === "/en/white" ? "bg-gray-50 hover:bg-gray-100 border border-gray-200" : ""}`}
        >
          <img
            src="/draft.png"
            alt="Draft"
